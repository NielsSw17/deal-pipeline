...
// Show 6 active stages in the board (Signed removed, Closed→Portfolio); Lost has its own view
const BOARD_STAGES = ['Sourcing', 'Screening', 'IC', 'Due Diligence', 'Portfolio', 'Postponed']
